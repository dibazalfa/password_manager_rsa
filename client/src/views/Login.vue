  ...
  <div class="container h-full px-6 py-24">
    ...
    <h2 class="mb-12 text-center text-5xl font-extrabold">Login</h2>
      ...
      <div class="mb-4">
        ...
        <input type="password" class="py-2 px-3 border border-gray-300 focus:border-red-300 focus:outline-none focus:ring focus:ring-red-200 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full " 
      ...
      <div class="mt-6">
        ...
        @click="App.Login(App.input.user)" >
          Sign In
         </button>
      </div>
      <div class="mt-6 text-center">
        <router-link to="/register" class="underline text-blue-500">Sign up for an account</router-link>
      </div>
  </div>
    </div>
  </div>
