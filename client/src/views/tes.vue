	...
	<div id="app">
		...
		<div class="fixed inset-0 flex z-40">
			...
			>
				...
				<div
					ref="content"
					class="transition-all duration-700 bg-gray-200 overflow-hidden flex "
      ...
      <div class="">
        ...
        <div
            class="absolute inset-1/2 rounded bg-green-500 w-2/5 h-5/6 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center text-white"
        >
            <!-- Page Content -->
            <p>isi</p>
        </div>
